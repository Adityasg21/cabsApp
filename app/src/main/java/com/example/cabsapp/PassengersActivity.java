...
public class PassengersActivity extends FragmentActivity implements OnMapReadyCallback, View.OnClickListener {
    ...
    private Button btnReqACar,btnBeepBeep;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnReqACar=findViewById(R.id.btnRequestCar);
        btnReqACar.setOnClickListener(this);
        ...
        carRequestQuery.findInBackground(new FindCallback<ParseObject>() {
            ...
            public void done(List<ParseObject> objects, ParseException e) {
                if(objects.size()>0&&e==null){
                    ...
                    btnReqACar.setText("cancel the car");
    ...
    private void updateCameraPassengerLocation(Location pLocation){
        ...
        mMap.addMarker(new MarkerOptions().position(passengerLocation).title("you are here").icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_CYAN)));}
            ...
            if (ContextCompat.checkSelfPermission(PassengersActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
                ...
                if (passengerCurrentLocation != null) {
                    ...
                    requestCar.saveInBackground(new SaveCallback() {
                        ...
                        public void done(ParseException e) {
                            if (e == null) {
                                Toast.makeText(PassengersActivity.this, "a car request is sent", Toast.LENGTH_LONG).show();
                                btnReqACar.setText("cancel the car");
                                isUberCancelled=false;
                            }
                        }
            ...
            carRequestQuery.findInBackground(new FindCallback<ParseObject>() {
                ...
                public void done(List<ParseObject> objects, ParseException e) {
                    if(objects.size()>0 && e==null){
                        ...
                        btnReqACar.setText("request a car");
                        ...
                        for (ParseObject request:objects){
                            request.deleteInBackground(new DeleteCallback() {
                                ...
                                public void done(ParseException e) {
                                    if(e==null){
                                       Toast.makeText(PassengersActivity.this,"request deleted",Toast.LENGTH_LONG).show();
                                    }
                                }
                            });
                        }
            ...
            public void run() {
                ...
                uberRequestQuery.findInBackground(new FindCallback<ParseObject>() {
                    ...
                    public void done(final List<ParseObject> objects, ParseException e) {
                        if(objects.size()>0 && e==null){
                            isCarReady=true;
                            for (final ParseObject reqObject:objects) {
                                ParseQuery<ParseUser> driverQuery=ParseUser.getQuery();
                                driverQuery.whereEqualTo("username",reqObject.getString("driverOfME"));
                                driverQuery.findInBackground(new FindCallback<ParseUser>() {
                                    ...
                                    public void done(List<ParseUser> drivers, ParseException e) {
                                        if(drivers.size()>0 && e==null){
                                            for(ParseUser driverOfReq:drivers){
                                                ParseGeoPoint driverOfRequestLocation=driverOfReq.getParseGeoPoint("driverLocation");
                                                if(ContextCompat.checkSelfPermission(PassengersActivity.this,Manifest.permission.ACCESS_FINE_LOCATION)==PackageManager.PERMISSION_GRANTED){
                                                    ...
                                                    float roundedDist=Math.round(milesDistance*10)/10;
                                                    if(milesDistance<0.3){

                                                        reqObject.deleteInBackground(new DeleteCallback() {
                                                            @Override
                                                            public void done(ParseException e) {
                                                                if(e==null){
                                                                    Toast.makeText(PassengersActivity.this,"car ready",Toast.LENGTH_LONG).show();
                                                                    isCarReady=false;
                                                                    isUberCancelled=true;
                                                                    btnReqACar.setText("you can book a car");
                                                                }
                                                            }
                                                        });
                                                    }else {

                                                        Toast.makeText(PassengersActivity.this, reqObject.getString("driverOfME") + " is" + roundedDist + " miles", Toast.LENGTH_LONG).show();
